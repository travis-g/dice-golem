...
var (
	...
	ErrSendMessagePermissions = errors.New("Sorry! A response message could not be posted here. Please make sure Dice Golem has _Send Messages_ permissions in this channel.")
)
